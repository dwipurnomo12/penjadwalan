                        ...
                        <table id="table_id" class="table table-bordered table-hover table-striped table-condensed">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-left">Dwi Purnomo</td>
                                    <td class="text-left">Hamid Muhammad Jumasa</td>
                                    <td>
                                        <a href="/kelas/edit" class="btn btn-warning"><i
                                                class="fa fa-pencil-square"></i></a>
                                        <form id="" action="/kelas/" method="POST" class="d-inline">
                                            @method('delete')
                                            @csrf
                                            <button type="submit" class="btn btn-danger swal-confirm" data-form=""><i
